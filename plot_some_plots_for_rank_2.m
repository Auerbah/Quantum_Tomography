...
par = [
       [0.00 T1 T2 flag_a_r flag_p_r 1 1]
       [0.2 T1 T2 flag_a_r flag_p_r 1 1]
       
       [0.00 T1 T2 flag_a_r flag_p_r 2 1]
       [0.2 T1 T2 flag_a_r flag_p_r 2 1]
       
       [0.00 T1 T2 flag_a_r flag_p_r 3 1]
       [0.2 T1 T2 flag_a_r flag_p_r 3 1]
       
%        [1.00 T1 T2 flag_a_r flag_p_r 2 4]
       ];
 n_par = size(par);
...
for i = 1:n_par
    ...
    [dF_average_teor, d] = dF_mixed_with_noise_new(x, dm, t,  T, T1,T2,flag_a_r,flag_p_r, n);
